...
//  RBEriksen skabelon
//
//  Created by Simon Elhoej Steinmejer on 05/03/18.
...
class LoginController: UIViewController
{
    ...
    lazy var carImage: CarAnimationImageView =
    {
    ...
    @objc private func handleEditingChanged()
    {
        guard let email = emailTextField.text else { return }
        guard let password = passwordTextField.text else { return }
        let isValid = email.count > 5 && password.count > 5
        
        loginButton.isEnabled = isValid ? true : false
        
        UIView.animate(withDuration: 0.3) {
            
            self.loginButton.alpha = isValid ? 1 : 0.7
        }
    }
    ...
    private func setupUI()
    {
        ...
        loginButton.anchor(top: passwordTextField.bottomAnchor, left: view.safeAreaLayoutGuide.leftAnchor, bottom: nil, right: view.safeAreaLayoutGuide.rightAnchor, paddingTop: 30, paddingLeft: 40, paddingRight: 40, paddingBottom: 0, width: 0, height: 50)
        
        ellerLabel.anchor(top: loginButton.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 60, paddingLeft: 0, paddingRight: 0, paddingBottom: 0, width: 0, height: 0)
        ...
        guestButton.anchor(top: ellerLabel.bottomAnchor, left: view.safeAreaLayoutGuide.leftAnchor, bottom: nil, right: view.safeAreaLayoutGuide.rightAnchor, paddingTop: 60, paddingLeft: 40, paddingRight: 40, paddingBottom: 0, width: 0, height: 50)
